...
########### Train Files
train_file = open("BIMPM_P2_predictions_train.txt","r")
train_data_PN, train_label = get_features_labels(train_file)

train_file = open("P_3_Easy_files/BIMPM_P3_predictions_train.txt","r")
train_data_P3, dummy1 = get_features_labels(train_file)


train_file = open("/Users/vikasy/SEM_5/ARC_EASY_Clark_Just/Easy_train_ranking.txt","r")
...
test_file = open("BIMPM_P2_predictions.txt","r")
test_data_PN, test_label = get_features_labels(test_file)

test_file = open("P_3_Easy_files/BIMPM_P3_predictions_test.txt","r")
test_data_P3, dummy1 = get_features_labels(test_file)

test_file = open("/Users/vikasy/SEM_5/ARC_EASY_Clark_Just/Easy_test_ranking.txt","r")
